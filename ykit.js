module.exports = {
    ...
    config: {
        ...
        modifyWebpackConfig: function (config) {
            ...
            // [配置] chunk 的路径
            config.output.local.publicPath = '//127.0.0.1/yo/prd/';
			...
			config.output.dev.publicPath = '//www.maodan.online/yo/prd/';
			config.output.prd.publicPath = '//www.maodan.online/yo/prd/';
            return config;
        }
    }
}
